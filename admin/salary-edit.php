        ...
        <div class="card-body">
            <form method="POST" action="">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control" id="luong_co_ban" name="luong_co_ban" min="0" step="100000" value="<?php echo $salary['luong_co_ban']; ?>" required>
                </div>
                
                <div class="mb-3">
                    <label for="luong_theo_order" class="form-label">Lương theo đơn (VNĐ)</label>
                    <input type="number" class="form-control" id="luong_theo_order" name="luong_theo_order" min="0" step="10000" value="<?php echo $salary['luong_theo_order']; ?>">
                </div>
                
                <div class="mb-3">
                    <label for="ngay_tra" class="form-label">Ngày trả lương</label>
                    <input type="date" class="form-control" id="ngay_tra" name="ngay_tra" value="<?php echo $salary['ngay_tra']; ?>">
